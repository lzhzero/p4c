...
parser ParserImpl(packet_in packet, out headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".parse_next_fwdHop") state parse_next_fwdHop1 {
        transition select(meta._my_metadata_fwdHopCount0) {
            8w0x0: parse_next_revHop;
            default: parse_fwdHop1;
        }
    }
    @name(".parse_next_fwdHop") state parse_next_fwdHop2 {
        transition select(meta._my_metadata_fwdHopCount0) {
            8w0x0: parse_next_revHop;
            default: parse_fwdHop2;
        }
    }
    @name(".parse_next_fwdHop") state parse_next_fwdHop3 {
        transition select(meta._my_metadata_fwdHopCount0) {
            8w0x0: parse_next_revHop;
            default: parse_fwdHop3;
        }
    }
    @name(".parse_next_fwdHop") state parse_next_fwdHop4 {
        transition select(meta._my_metadata_fwdHopCount0) {
            8w0x0: parse_next_revHop;
            default: parse_fwdHop4;
        }
    }
    @name(".parse_next_fwdHop") state parse_next_fwdHop5 {
        transition select(meta._my_metadata_fwdHopCount0) {
            8w0x0: parse_next_revHop;
            default: parse_fwdHop5;
        }
    }
    @name(".parse_next_fwdHop") state parse_next_fwdHop6 {
        transition select(meta._my_metadata_fwdHopCount0) {
            8w0x0: parse_next_revHop;
            default: parse_fwdHop6;
        }
    }
    @name(".parse_next_fwdHop") state parse_next_fwdHop7 {
        transition select(meta._my_metadata_fwdHopCount0) {
            8w0x0: parse_next_revHop;
            default: parse_fwdHop7;
        }
    }
    @name(".parse_next_fwdHop") state parse_next_fwdHop8 {
        transition select(meta._my_metadata_fwdHopCount0) {
            8w0x0: parse_next_revHop;
            default: parse_fwdHop8;
        }
    }
    @name(".parse_next_fwdHop") state parse_next_fwdHop9 {
        transition select(meta._my_metadata_fwdHopCount0) {
            8w0x0: parse_next_revHop;
            default: parse_fwdHop9;
        }
    }
    @name(".parse_next_fwdHop") state parse_next_fwdHop10 {
        transition select(meta._my_metadata_fwdHopCount0) {
            8w0x0: parse_next_revHop;
            default: parse_fwdHop10;
        }
    }
    @name(".parse_next_fwdHop") state parse_next_fwdHop11 {
        transition select(meta._my_metadata_fwdHopCount0) {
            8w0x0: parse_next_revHop;
            default: parse_fwdHop11;
        }
    }
    @name(".parse_next_fwdHop") state parse_next_fwdHop12 {
        transition select(meta._my_metadata_fwdHopCount0) {
            8w0x0: parse_next_revHop;
            default: parse_fwdHop12;
        }
    }
    @name(".parse_next_fwdHop") state parse_next_fwdHop13 {
        transition select(meta._my_metadata_fwdHopCount0) {
            8w0x0: parse_next_revHop;
            default: parse_fwdHop13;
        }
    }
    @name(".parse_next_fwdHop") state parse_next_fwdHop14 {
        transition select(meta._my_metadata_fwdHopCount0) {
            8w0x0: parse_next_revHop;
            default: parse_fwdHop14;
        }
    }
    @name(".parse_next_fwdHop") state parse_next_fwdHop15 {
        transition select(meta._my_metadata_fwdHopCount0) {
            8w0x0: parse_next_revHop;
            default: parse_fwdHop15;
        }
    }
    @name(".parse_next_fwdHop") state parse_next_fwdHop16 {
        transition select(meta._my_metadata_fwdHopCount0) {
            8w0x0: parse_next_revHop;
            default: parse_fwdHop16;
        }
    }
    @name(".parse_next_fwdHop") state parse_next_fwdHop17 {
        transition select(meta._my_metadata_fwdHopCount0) {
            8w0x0: parse_next_revHop;
            default: parse_fwdHop17;
        }
    }
    @name(".parse_next_fwdHop") state parse_next_fwdHop18 {
        transition select(meta._my_metadata_fwdHopCount0) {
            8w0x0: parse_next_revHop;
            default: parse_fwdHop18;
        }
    }
    @name(".parse_next_fwdHop") state parse_next_fwdHop19 {
        transition select(meta._my_metadata_fwdHopCount0) {
            8w0x0: parse_next_revHop;
            default: parse_fwdHop19;
        }
    }
    @name(".parse_next_fwdHop") state parse_next_fwdHop20 {
        transition select(meta._my_metadata_fwdHopCount0) {
            8w0x0: parse_next_revHop;
            default: parse_fwdHop20;
        }
    }
    @name(".parse_next_fwdHop") state parse_next_fwdHop21 {
        transition select(meta._my_metadata_fwdHopCount0) {
            8w0x0: parse_next_revHop;
            default: parse_fwdHop21;
        }
    }
    @name(".parse_next_fwdHop") state parse_next_fwdHop22 {
        transition select(meta._my_metadata_fwdHopCount0) {
            8w0x0: parse_next_revHop;
            default: parse_fwdHop22;
        }
    }
    @name(".parse_next_fwdHop") state parse_next_fwdHop23 {
        transition select(meta._my_metadata_fwdHopCount0) {
            8w0x0: parse_next_revHop;
            default: parse_fwdHop23;
        }
    }
    @name(".parse_next_fwdHop") state parse_next_fwdHop24 {
        transition select(meta._my_metadata_fwdHopCount0) {
            8w0x0: parse_next_revHop;
            default: parse_fwdHop24;
        }
    }
    @name(".parse_next_fwdHop") state parse_next_fwdHop25 {
        transition select(meta._my_metadata_fwdHopCount0) {
            8w0x0: parse_next_revHop;
            default: parse_fwdHop25;
        }
    }
    @name(".parse_next_fwdHop") state parse_next_fwdHop26 {
        transition select(meta._my_metadata_fwdHopCount0) {
            8w0x0: parse_next_revHop;
            default: parse_fwdHop26;
        }
    }
    @name(".parse_next_fwdHop") state parse_next_fwdHop27 {
        transition select(meta._my_metadata_fwdHopCount0) {
            8w0x0: parse_next_revHop;
            default: parse_fwdHop27;
        }
    }
    @name(".parse_next_fwdHop") state parse_next_fwdHop28 {
        transition select(meta._my_metadata_fwdHopCount0) {
            8w0x0: parse_next_revHop;
            default: parse_fwdHop28;
        }
    }
    @name(".parse_next_fwdHop") state parse_next_fwdHop29 {
        transition select(meta._my_metadata_fwdHopCount0) {
            8w0x0: parse_next_revHop;
            default: parse_fwdHop29;
        }
    }
    @name(".parse_next_fwdHop") state parse_next_fwdHop30 {
        transition select(meta._my_metadata_fwdHopCount0) {
            8w0x0: parse_next_revHop;
            default: parse_fwdHop30;
        }
    }
    @name(".parse_next_fwdHop") state parse_next_fwdHop31 {
        transition select(meta._my_metadata_fwdHopCount0) {
            8w0x0: parse_next_revHop;
            default: parse_fwdHop31;
        }
    }
    @name(".parse_next_fwdHop") state parse_next_fwdHop32 {
        transition select(meta._my_metadata_fwdHopCount0) {
            8w0x0: parse_next_revHop;
            default: parse_fwdHop32;
        }
    }
    @name(".parse_next_fwdHop") state parse_next_fwdHop33 {
        transition select(meta._my_metadata_fwdHopCount0) {
            8w0x0: parse_next_revHop;
            default: parse_fwdHop33;
        }
    }
    @name(".parse_next_fwdHop") state parse_next_fwdHop34 {
        transition select(meta._my_metadata_fwdHopCount0) {
            8w0x0: parse_next_revHop;
            default: parse_fwdHop34;
        }
    }
    @name(".parse_next_fwdHop") state parse_next_fwdHop35 {
        transition select(meta._my_metadata_fwdHopCount0) {
            8w0x0: parse_next_revHop;
            default: parse_fwdHop35;
        }
    }
    @name(".parse_next_fwdHop") state parse_next_fwdHop36 {
        transition select(meta._my_metadata_fwdHopCount0) {
            8w0x0: parse_next_revHop;
            default: parse_fwdHop36;
        }
    }
    @name(".parse_next_fwdHop") state parse_next_fwdHop37 {
        transition select(meta._my_metadata_fwdHopCount0) {
            8w0x0: parse_next_revHop;
            default: parse_fwdHop37;
        }
    }
    @name(".parse_next_fwdHop") state parse_next_fwdHop38 {
        transition select(meta._my_metadata_fwdHopCount0) {
            8w0x0: parse_next_revHop;
            default: parse_fwdHop38;
        }
    }
    @name(".parse_next_fwdHop") state parse_next_fwdHop39 {
        transition select(meta._my_metadata_fwdHopCount0) {
            8w0x0: parse_next_revHop;
            default: parse_fwdHop39;
        }
    }
    @name(".parse_next_fwdHop") state parse_next_fwdHop40 {
        transition select(meta._my_metadata_fwdHopCount0) {
            8w0x0: parse_next_revHop;
            default: parse_fwdHop40;
        }
    }
    @name(".parse_next_fwdHop") state parse_next_fwdHop41 {
        transition select(meta._my_metadata_fwdHopCount0) {
            8w0x0: parse_next_revHop;
            default: parse_fwdHop41;
        }
    }
    @name(".parse_next_fwdHop") state parse_next_fwdHop42 {
        transition select(meta._my_metadata_fwdHopCount0) {
            8w0x0: parse_next_revHop;
            default: parse_fwdHop42;
        }
    }
    @name(".parse_next_fwdHop") state parse_next_fwdHop43 {
        transition select(meta._my_metadata_fwdHopCount0) {
            8w0x0: parse_next_revHop;
            default: parse_fwdHop43;
        }
    }
    @name(".parse_next_fwdHop") state parse_next_fwdHop44 {
        transition select(meta._my_metadata_fwdHopCount0) {
            8w0x0: parse_next_revHop;
            default: parse_fwdHop44;
        }
    }
    @name(".parse_next_fwdHop") state parse_next_fwdHop45 {
        transition select(meta._my_metadata_fwdHopCount0) {
            8w0x0: parse_next_revHop;
            default: parse_fwdHop45;
        }
    }
    @name(".parse_next_fwdHop") state parse_next_fwdHop46 {
        transition select(meta._my_metadata_fwdHopCount0) {
            8w0x0: parse_next_revHop;
            default: parse_fwdHop46;
        }
    }
    @name(".parse_next_fwdHop") state parse_next_fwdHop47 {
        transition select(meta._my_metadata_fwdHopCount0) {
            8w0x0: parse_next_revHop;
            default: parse_fwdHop47;
        }
    }
    @name(".parse_next_fwdHop") state parse_next_fwdHop48 {
        transition select(meta._my_metadata_fwdHopCount0) {
            8w0x0: parse_next_revHop;
            default: parse_fwdHop48;
        }
    }
    @name(".parse_next_fwdHop") state parse_next_fwdHop49 {
        transition select(meta._my_metadata_fwdHopCount0) {
            8w0x0: parse_next_revHop;
            default: parse_fwdHop49;
        }
    }
    @name(".parse_next_fwdHop") state parse_next_fwdHop50 {
        transition select(meta._my_metadata_fwdHopCount0) {
            8w0x0: parse_next_revHop;
            default: parse_fwdHop50;
        }
    }
    @name(".parse_next_fwdHop") state parse_next_fwdHop51 {
        transition select(meta._my_metadata_fwdHopCount0) {
            8w0x0: parse_next_revHop;
            default: parse_fwdHop51;
        }
    }
    @name(".parse_next_fwdHop") state parse_next_fwdHop52 {
        transition select(meta._my_metadata_fwdHopCount0) {
            8w0x0: parse_next_revHop;
            default: parse_fwdHop52;
        }
    }
    @name(".parse_next_fwdHop") state parse_next_fwdHop53 {
        transition select(meta._my_metadata_fwdHopCount0) {
            8w0x0: parse_next_revHop;
            default: parse_fwdHop53;
        }
    }
    @name(".parse_next_fwdHop") state parse_next_fwdHop54 {
        transition select(meta._my_metadata_fwdHopCount0) {
            8w0x0: parse_next_revHop;
            default: parse_fwdHop54;
        }
    }
    @name(".parse_next_fwdHop") state parse_next_fwdHop55 {
        transition select(meta._my_metadata_fwdHopCount0) {
            8w0x0: parse_next_revHop;
            default: parse_fwdHop55;
        }
    }
    @name(".parse_next_fwdHop") state parse_next_fwdHop56 {
        transition select(meta._my_metadata_fwdHopCount0) {
            8w0x0: parse_next_revHop;
            default: parse_fwdHop56;
        }
    }
    @name(".parse_next_fwdHop") state parse_next_fwdHop57 {
        transition select(meta._my_metadata_fwdHopCount0) {
            8w0x0: parse_next_revHop;
            default: parse_fwdHop57;
        }
    }
    @name(".parse_next_fwdHop") state parse_next_fwdHop58 {
        transition select(meta._my_metadata_fwdHopCount0) {
            8w0x0: parse_next_revHop;
            default: parse_fwdHop58;
        }
    }
    @name(".parse_next_fwdHop") state parse_next_fwdHop59 {
        transition select(meta._my_metadata_fwdHopCount0) {
            8w0x0: parse_next_revHop;
            default: parse_fwdHop59;
        }
    }
    @name(".parse_next_fwdHop") state parse_next_fwdHop60 {
        transition select(meta._my_metadata_fwdHopCount0) {
            8w0x0: parse_next_revHop;
            default: parse_fwdHop60;
        }
    }
    @name(".parse_next_fwdHop") state parse_next_fwdHop61 {
        transition select(meta._my_metadata_fwdHopCount0) {
            8w0x0: parse_next_revHop;
            default: parse_fwdHop61;
        }
    }
    @name(".parse_next_fwdHop") state parse_next_fwdHop62 {
        transition select(meta._my_metadata_fwdHopCount0) {
            8w0x0: parse_next_revHop;
            default: parse_fwdHop62;
        }
    }
    @name(".parse_next_fwdHop") state parse_next_fwdHop63 {
        transition select(meta._my_metadata_fwdHopCount0) {
            8w0x0: parse_next_revHop;
            default: parse_fwdHop63;
        }
    }
    @name(".parse_next_fwdHop") state parse_next_fwdHop64 {
        transition select(meta._my_metadata_fwdHopCount0) {
            8w0x0: parse_next_revHop;
